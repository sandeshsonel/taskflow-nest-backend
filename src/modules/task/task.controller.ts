...
export class TaskController {
  ...
  getTaskById(@Param('id') id: string, @GetUser() user: JwtPayload) {
  ...
  createTask(
    ...
    @Query('adminUser', new DefaultValuePipe(false), ParseBoolPipe)
    adminUser: boolean,
  ) {
  ...
  @ApiQuery({
    name: 'adminId',
    required: false,
    description: 'The admin ID if updating on behalf of an admin',
  })
  ...
  deleteTask(@GetUser() user: JwtPayload, @Query('taskId') taskId: string) {
